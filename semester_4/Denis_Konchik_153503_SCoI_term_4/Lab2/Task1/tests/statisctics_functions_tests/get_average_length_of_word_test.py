"""Tests for get_average_length_of_word function"""

from ...src.statistics_functions import get_average_length_of_word
...
def test_normal_text():
    ...
    assert round(get_average_length_of_word(text), 2) == round(53 / 13, 2)
    ...
    assert round(get_average_length_of_word(text), 2) == round(104 / 25, 2)
    ...
    assert round(get_average_length_of_word(text), 2) == round(165 / 40, 2)
