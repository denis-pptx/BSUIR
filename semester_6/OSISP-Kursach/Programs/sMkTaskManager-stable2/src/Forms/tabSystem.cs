...
internal class tabSystem : UserControl, ITaskManagerTab {
    ...
    private void InitializeComponent() {
        ...
        lblSupport1.Location = new Point(4, 321);
        ...
        lblSupport2.Location = new Point(4, 339);
        ...
        lblSupport3.Location = new Point(4, 357);
        ...
        lblSupport4.Location = new Point(4, 375);
        ...
        lblSystem1.Location = new Point(4, 21);
        ...
        lblSystem2.Location = new Point(4, 39);
        ...
        lblSystem3.Location = new Point(4, 57);
        ...
        lblSystem4.Location = new Point(4, 75);
        ...
        lblComputer.Location = new Point(4, 140);
        ...
        lblComputer1.Location = new Point(4, 160);
        ...
        lblComputer2.Location = new Point(4, 180);
        ...
        lblComputer3.Location = new Point(4, 200);
        ...
        lblComputer4.Location = new Point(4, 220);
        ...
        lblComputer5.Location = new Point(4, 240);
        ...
        lblRegister.Location = new Point(4, 280);
    ...
    public string Title { get; set; } = "Computer";
